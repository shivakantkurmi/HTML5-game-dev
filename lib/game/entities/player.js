...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
        ...
        kill: function() {
            ...
            // spawn the death explosion and register the respawn as a callback
    ...
    EntityBullet = ig.Entity.extend({
        ...
        handleMovementTrace: function( res ) {
            this.parent( res );
            // if we hit the collision map then destroy us
    ...
    EntityGrenade = ig.Entity.extend({
        ...
        type: ig.Entity.TYPE.NONE,
        checkAgainst: ig.Entity.TYPE.BOTH, // allows collision with Zombie AND Player
        collides: ig.Entity.COLLIDES.PASSIVE,
        maxVel: {x: 200, y: 200},
        bounciness: 0.6,
        bounceCounter: 0,
